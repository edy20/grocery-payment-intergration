...
<?php if(!empty($order)) { ?>
    <form name="frm_customer_detail" action="https://www.paynow.co.zw/Payment/BillPaymentLink/?q=aWQ9MTMyNTImYW1vdW50PTAuMDAmYW1vdW50X3F1YW50aXR5PTAuMDAmbD0w" method="POST">
    <input type='hidden'
